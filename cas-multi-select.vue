...
<div :class="classes" v-clickoutside="handleClose">
    <div :class="[prefixCls + '-rel']" @click="toggleOpen" ref="reference">
        ...
        <i-input :element-id="elementId" ref="input" class="text-ellipsis" :title="displayRender" :readonly="true" :disabled="disabled" :value="setLabelText == '' ? displayRender : setLabelText" :size="size" :placeholder="inputPlaceholder"></i-input>
    ...
    <transition name="slide-up">
        <div class="ivu-select-dropdown cascader-multi" v-show="visible" v-if="!destroy" :class="{ [prefixCls + '-transfer']: transfer }" ref="drop" :data-transfer="transfer" v-transfer-dom>
            <div>
                <casMultiPanel v-if="data.length" @handleGetSelected="selectedData" :data="formatData" :oneToone="oneToone" :allToone="allToone" :componentId="componentId"></casMultiPanel>
            </div>
        </div>
    </transition>
</div>
...
<script>
import casMultiPanel from "./cas-multi-select-panel.vue";
